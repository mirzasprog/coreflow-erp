...
export default function InventoryList() {
  ...
  const { data: documents, isLoading } = useWarehouseDocuments('inventory');
  ...
  return (
    <div>
      <Header title="Inventory Count" subtitle="Inventura • Physical stock count" />
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right">Difference Value</TableHead>
                  ...
                  filteredDocuments?.map((doc) => (
                    <TableRow key={doc.id}>
                      ...
                      <TableCell className="text-right">
                        <span className={doc.total_value >= 0 ? 'text-green-600' : 'text-red-600'}>
                      ...
                      <TableCell>
                        <div className="flex gap-1">
                          <Button
                            variant="ghost"
                            size="icon"
                            onClick={() => navigate(`/warehouse/inventory/${doc.id}`)}
                          >
                          ...
                          {doc.status === 'draft' && (
                            <>
                              <Button
                                variant="ghost"
                                size="icon"
                                onClick={() => navigate(`/warehouse/inventory/${doc.id}/edit`)}
                              >
